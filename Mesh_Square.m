function [coords, conecs, nonod_t, noelem_t, ndtx, eltx] = Mesh_Square(rank_x, rank_y, lngth_x, lngth_y, mode)
% This function produces a mesh with "rank" iterations of unitcellin X- and Y-direction.
%
...
for irank = 1:rank_x+1                                                     % numbering the nodes and calculating their coordinates
    xpoin = (irank-1)*lngth_x;
    for jrank = 1:rank_y+1
        ypoin = (jrank-1)*lngth_y;
        inode = inode + 1;
